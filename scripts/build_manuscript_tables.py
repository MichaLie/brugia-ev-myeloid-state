...
def build_orthogonal_validation_table() -> pd.DataFrame:
    ...
    for contrast_name, label in [
        ...
        rows.append(
            {
                "analysis_layer": "orthogonal_validation",
                "dataset": "GSE187403",
                "contrast": label,
...
def build_manifest() -> str:
    return "\n".join(
        [
            ...
            "  Suggested caption: Summary of TLR-context and orthogonal perturbation validation across GSE147310, GSE187403, and GSE143170.",
            "- `external_transport_contrast_summary.csv`",
            "  Suggested caption: Contrast-level external transport summary across direct Brugia exposure, natural infection, same-parasite stress-test, and cross-helminth datasets.",
            "- `external_transport_context_summary.csv`",
            "  Suggested caption: Context-level arm transport summary showing differential down-arm and up-arm behavior across external settings.",
            ...
            "",
            "## Repository use",
            "- These tables are derived, manuscript-facing summaries built from the repository evidence and validation outputs.",
            "- They are suitable for supplements, appendices, or public repository browsing without journal-specific packaging.",
        ]
    ) + "\n"
