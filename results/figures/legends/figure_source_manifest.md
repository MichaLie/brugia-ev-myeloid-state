...
| Figure 3 | `results/figures/main/` | `data/evidence/core/regulator_panel_target_rerun_results.csv`; `data/evidence/core/mir100_mtor_positive_control.csv`; `data/evidence/core/frozen_signature_6mer_enrichment.csv`; `data/evidence/core/frozen_signature_7mer_enrichment.csv` |
...
| Figure S3 | `results/figures/supplementary/` | `results/validation/gse187403_gene_level_validation.csv`; `results/tables/gse143170_paired_deseq2_gene_level.csv` |
